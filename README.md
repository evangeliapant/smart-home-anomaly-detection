...
- Default in this branch: **5-minute windows**
...
- **Anomalies**
  ...
  - in this branch they usually represent unusual short bursts or fine-grained behavioral windows,
  - in the `feature/1h-window-analysis` branch they represent unusual hours.
...
3. Run the full processing pipeline with the default 5-minute windowing:
...
```bash
python -m scripts.run_pipeline --window-minutes 60
```
